...
def validate_numero_telefone(phone_number):
    ...
    # \(\d{2}\): Dois dígitos entre parênteses, representando o DDD.
    # Um espaço em branco
    # 9 como primeiro digito fixo
    # \d{4}: 4 dígitos, representando o número principal.
    # - separa os 4 ultimos numeros
